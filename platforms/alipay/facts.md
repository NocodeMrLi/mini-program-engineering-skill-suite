...
- 事实：支付宝小程序版本发布需在开放平台控制台完成上传、提审与发布操作；审核要求与驳回处理以平台当前规则为准。
  <!-- fact: release-review-flow verified=2026-08-30 source=https://opendocs.alipay.com/mini/introduce/release digest=unknown -->
- 事实：使用涉及用户信息的接口需按平台要求配置隐私协议并遵循用户授权与撤回路径；具体清单以平台当前文档为准。
  <!-- fact: privacy-protection verified=2026-08-30 source=https://opendocs.alipay.com/mini/03lwro digest=unknown -->
