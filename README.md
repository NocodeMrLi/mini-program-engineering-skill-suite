<p align="center">
  <img src="assets/readme-cover.webp?v=3.0.1" alt="小程序开发工程技能套件 封面" width="100%">
</p>
...
```bash
tar -xzf mini-program-engineering-suite-v3.0.1.tar.gz
python3 mini-program-engineering-suite-v3.0.1/scripts/verify_public_package.py \
  mini-program-engineering-suite-v3.0.1
```
