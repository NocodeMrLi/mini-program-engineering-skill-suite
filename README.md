...
```bash
tar -xzf mini-program-engineering-suite-v2.2.1.tar.gz
python3 mini-program-engineering-suite-v2.2.1/scripts/verify_public_package.py \
  mini-program-engineering-suite-v2.2.1
```
