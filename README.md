...
```bash
tar -xzf mini-program-engineering-suite-v3.0.0.tar.gz
python3 mini-program-engineering-suite-v3.0.0/scripts/verify_public_package.py \
  mini-program-engineering-suite-v3.0.0
```
