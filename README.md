<p align="center">
  <img src="assets/readme-cover.webp?v=3.1.2" alt="小程序开发工程技能套件 封面" width="100%">
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-3.1.2-0EA5E9.svg" alt="Version: 3.1.2">
</p>
...
```bash
tar -xzf mini-program-engineering-suite-v3.1.2.tar.gz
python3 mini-program-engineering-suite-v3.1.2/scripts/verify_public_package.py \
  mini-program-engineering-suite-v3.1.2
```
